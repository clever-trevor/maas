...
# This file creates the indexes for Elastic 6.x as mappings format is different (sigh)
import urllib.parse
import os
import glob
import datetime
...
def create_indices ():
  ...
  settings = {"settings":{ "number_of_shards" : 1, "number_of_replicas":0 }, "mappings":{ "_doc":{"properties":{"last_updated":{"type":"date","format":"dd/MM/yyyy HH:mm:ss"}}}}}
  ...
  settings = {"settings":{ "number_of_shards" : 1, "number_of_replicas":0 }, "mappings":{ "_doc": {"properties":{"timestamp":{"type":"date","format":"dd/MM/yyyy HH:mm:ss"},"metric_timestamp":{"type":"date","format":"yyyy-MM-dd HH:mm:ss"}}}}}
  ...
  settings = {"settings":{ "number_of_shards" : 1, "number_of_replicas":0 }, "mappings":{ "_doc": {"properties":{"timestamp":{"type":"date","format":"dd/MM/yyyy HH:mm:ss"}}}}}
